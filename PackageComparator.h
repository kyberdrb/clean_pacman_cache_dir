...
struct PackageComparator {
    bool operator()(const std::unique_ptr<Package_refactored_>& onePackage, const std::unique_ptr<Package_refactored_>& anotherPackage) const {
...
//        return onePackage->getName() < anotherPackage->getName();
    ...
    bool operator()(const std::unique_ptr<PackageWithInferredName_refactored_>& onePackage, const std::unique_ptr<PackageWithInferredName_refactored_>& anotherPackage) const {
        return onePackage < anotherPackage;
    }

    bool operator()(const std::unique_ptr<Package_refactored_>& onePackage, const std::unique_ptr<PackageWithInferredName_refactored_>& anotherPackage) const {
        return onePackage < anotherPackage;
    }

    bool operator()(const std::unique_ptr<PackageWithInferredName_refactored_>& onePackage, const std::unique_ptr<Package_refactored_>& anotherPackage) const {
        return onePackage < anotherPackage;
    }
};
